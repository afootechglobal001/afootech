...
<head>
    ...
    <title><?php echo $appName ?> | Certificate Verification</title>

    <meta name="description"
        content="Verify student certificates issued by <?php echo $appName ?>. Use our official certificate verification portal to confirm the authenticity of ICT training certificates issued to students." />
    ...
    <meta name="twitter:description"
        content="Verify the authenticity of student certificates issued by <?php echo $appName ?> using our secure online verification system." />

</head>

<body>
    <section class="certificate-body">
        <div class="certificate-div-in">
            ff
        </div>
    </section>
</body>
