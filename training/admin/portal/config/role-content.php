    ...
    <div class="page-title-div" data-aos="fade-in" data-aos-duration="1500">
        ...
        <div class="btn-div">
            <div class="search-div">
                <input type="text" id="searchContent" onkeyup="_filterRoles(this.value);" placeholder="Search role Here...">
                <i class="bi bi-search"></i>
            </div>
            <button class="btn" title="ADD NEW ROLE" onclick="sessionStorage.removeItem('getEachRoleDetails'); _getForm({page: 'roleReg', url: trainingAdminPortalMiddlewareUrl});">
        ...
        <div class="container-back-div">
            ...
            <script>
                $(document).ready(function() {
                    let showButton = '';
                    showButton =
                        `<button class="btn" title="Edit User Role" id="edit_btn" onclick="_getForm({page: 'roleReg', url: trainingAdminPortalMiddlewareUrl});">
