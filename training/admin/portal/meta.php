...
<script src="<?php echo $websiteUrl?>/training/admin/portal/js/jquery.datetimepicker.js"></script>
<script src="<?php echo $websiteUrl?>/training/admin/portal/js/chart.min.js"></script>
<script src="<?php echo $websiteUrl?>/training/admin/portal/js/canvasjs.min.js" type="text/javascript"></script>
