...
<head>
    ...
    <title><?php echo $appName ?> | Program Details</title>
</head>
                ...
                <div class="form-back-div">
                    <div class="form-div" data-aos="fade-in" data-aos-duration="1200">
                        ...
                        <div class="inner-form" id="viewLogin">
                            ...
                            <div class="btn-div">
                                <button class="btn back-btn" title="Back to previous" onclick="window.location.href = institutionDetailsUrl;"><i class="bi-arrow-left"></i> Back</button>
                                <button class="btn" id="submitBtn" title="Proceed" onclick="window.location.href = uploadPassportUrl;">Proceed <i class="bi-arrow-right"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
